...
export const AddExpenseForm = () => {
  ...
  const [date, setDate] = useState<string>(
    [today.getFullYear(), finalMonth, today.getDate()].join("-")
  );
  ...
  const checkFormValidity = () => {
    ...
    const payerValid = payer !== undefined;
        ...
        <Row>
          <Col xs={12}>
            <StyledFormGroup>
              ...
              />
              <Form.Control.Feedback data-valid={isDescValid} type="invalid">
                비용 내용을 입력해 주셔야 합니다.
        ...
        <Row>
          ...
          <Col xs={12} lg={6}>
            <StyledFormGroup>
              ...
              >
                <option value={undefined}>누가 결제 했나요??</option>
                {members.map((member) => (
...
const StyledSubmitButton = styled(Button).attrs({
  ...
  height: 58px;
  border-radius: 8px;
  background-color: #e2d9f8 !important;
  color: #59359a;
  gap: 8px;
  padding: 16px 32px;
  border: 0px;
